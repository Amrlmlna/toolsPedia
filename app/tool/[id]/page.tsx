            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  {tool.tags.map((tag) => (
                    <Badge key={tag} variant="secondary" className="bg-blue-500/10 text-blue-500 hover:bg-blue-500/20">
                      {tag}
                    </Badge>
                  ))}
                </div>
              ...
              <div>
                ...
                <p>{new Date(tool.addedDate).toLocaleDateString()}</p>
              </div>
            </div>
                      ...
                      <CardContent className="p-4 pt-0">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center">
                            ...
                            <span className="text-xs ml-1">{relatedTool.rating.toFixed(1)}</span>
                          </div>
                          <Button
                            size="sm"
                            variant="outline"
          ...
          {relatedTools.map((relatedTool) => (
            ...
            >
              <div className="aspect-video relative bg-muted">
                <Image
                  src={relatedTool.imageUrl || "/placeholder.svg?height=200&width=400"}
              ...
              <CardContent className="p-4 pt-0">
                <div className="flex items-center gap-1 mb-3">
                  ...
                  <span className="text-sm ml-1">{relatedTool.rating.toFixed(1)}</span>
                </div>
              </CardContent>
